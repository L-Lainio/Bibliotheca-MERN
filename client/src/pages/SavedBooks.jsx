...
const SavedBooks = () => {
  ...
  // Set userData to the result of the query (with a fallback to an empty object)
  const userData = data?.me || {};

  // Create function that accepts the book's bookId value as param and deletes the book
